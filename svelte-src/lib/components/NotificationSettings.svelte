...
<div class="fixed inset-0 z-[201] flex items-end md:items-center md:justify-center animate-fade-in pointer-events-none" style="padding-top: env(safe-area-inset-top);">
  ...
  <!-- svelte-ignore a11y_no_static_element_interactions -->
  <div
    class="bg-black border-t border-white/10 md:border md:rounded-2xl w-full md:max-w-md flex flex-col rounded-t-2xl max-h-[85vh] animate-slide-up md:animate-scale-in pointer-events-auto"
